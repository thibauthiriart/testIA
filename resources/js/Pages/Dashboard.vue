                    ...
                    <div class="bg-blue-50 dark:bg-blue-900/20 p-6 rounded-lg">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-2xl font-bold text-gray-800 dark:text-white">{{ stats.departments_count }}</p>
                            </div>
                    ...
                    <div class="bg-green-50 dark:bg-green-900/20 p-6 rounded-lg">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-2xl font-bold text-gray-800 dark:text-white">{{ stats.cities_count }}</p>
                            </div>
                    ...
                    <div class="bg-purple-50 dark:bg-purple-900/20 p-6 rounded-lg">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-2xl font-bold text-gray-800 dark:text-white">{{ formatNumber(stats.total_population) }}</p>
                            </div>
